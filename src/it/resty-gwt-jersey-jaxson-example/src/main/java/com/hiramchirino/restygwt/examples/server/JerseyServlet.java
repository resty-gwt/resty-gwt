...
public class JerseyServlet extends com.sun.jersey.spi.container.servlet.ServletContainer {
    ...
    static {
        initParams.put("com.sun.jersey.config.property.packages", "com.hiramchirino.restygwt.examples.server;org.codehaus.jackson.jaxrs");
    }
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        HttpServletRequestWrapper wrapper = new HttpServletRequestWrapper(request) {
            ...
            public String getServletPath() {
                if( getPathInfo().startsWith("/com.hiramchirino.restygwt.examples.JERSEY_JAXSON.JUnit/rest") ) {
                    return "/com.hiramchirino.restygwt.examples.JERSEY_JAXSON.JUnit/rest";
                }
