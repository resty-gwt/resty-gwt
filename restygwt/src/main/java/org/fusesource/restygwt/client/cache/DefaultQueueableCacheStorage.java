 ...
 * when retrieved from the cache the Response will have an extra header field
 * "X-Resty-Cache". this allows CallbackFilter to determine the action on
 * whether the Response came from the cache or just came over the wire.
 * 
 * @author kristian
 * 
 */
